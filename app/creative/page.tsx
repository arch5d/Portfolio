  ...
  return (
    <div className="max-w-3xl space-y-8">
      ...
      <section className="rounded-mdx border border-black/5 bg-white p-6 shadow-card">
        ...
        <p className="mt-2 text-muted">Music is my creative counterpart to systems thinking. I write and perform as part of Maenka.</p>
      </section>
      <section className="rounded-mdx border border-black/5 bg-white p-6 shadow-card">
      ...
      <section className="rounded-mdx border border-black/5 bg-white p-6 shadow-card">
        ...
        <div className="mt-2 flex flex-col gap-2 text-accent">
          <a href="https://www.bandlab.com/" target="_blank">BandLab</a>
          <a href="https://soundtrap.com/" target="_blank">Soundtrap</a>
          <a href="https://instagram.com/_maenka" target="_blank">Instagram @_maenka</a>
        </div>
      </section>
    </div>
  );
